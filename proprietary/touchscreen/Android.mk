...
include $(CLEAR_VARS)
LOCAL_MODULE        := firmware_touch_chip_id_0x74_config_id_0x0011_bin
...
include $(CLEAR_VARS)
LOCAL_MODULE        := firmware_touch_chip_id_0x74_config_id_0x0460_bin
LOCAL_MODULE_OWNER  := Sony Mobile
...
include $(CLEAR_VARS)
LOCAL_MODULE        := firmware_touch_chip_id_0x75_config_id_0x0010_bin
LOCAL_MODULE_OWNER  := Sony Mobile
...
include $(CLEAR_VARS)
LOCAL_MODULE        := firmware_touch_chip_id_0x75_config_id_0x0012_bin
LOCAL_MODULE_OWNER  := Sony Mobile
...
include $(CLEAR_VARS)
LOCAL_MODULE        := firmware_touch_chip_id_0x75_config_id_0x0013_bin
LOCAL_MODULE_OWNER  := Sony Mobile
...
include $(CLEAR_VARS)
LOCAL_MODULE        := firmware_touch_module_id_0x43_img
LOCAL_MODULE_OWNER  := Sony Mobile
LOCAL_SRC_FILES     := etc/firmware/touch_module_id_0x43.img
LOCAL_MODULE_TAGS   := optional
LOCAL_MODULE_STEM   := touch_module_id_0x43
...
include $(CLEAR_VARS)
LOCAL_MODULE        := firmware_touch_module_id_0x44_img
LOCAL_MODULE_OWNER  := Sony Mobile
LOCAL_SRC_FILES     := etc/firmware/touch_module_id_0x44.img
LOCAL_MODULE_TAGS   := optional
LOCAL_MODULE_STEM   := touch_module_id_0x44
LOCAL_MODULE_SUFFIX := .img
LOCAL_MODULE_CLASS  := ETC
LOCAL_MODULE_PATH   := $(TARGET_OUT_ETC)/firmware
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE        := usr_idc_max1187x_touchscreen_0_idc
LOCAL_MODULE_OWNER  := Sony Mobile
